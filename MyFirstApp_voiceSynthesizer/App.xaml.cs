...
namespace MyFirstApp_voiceSynthesizer
{
    public partial class App : Application
    {
        ...
        {
            try
            {   // Try block recommended to detect compilation errors in VCD file.
                await VoiceCommandService.InstallCommandSetsFromFileAsync(new Uri("ms-appx:///magicMemoVCD.xml"));   // Inspects and validates every commands in the file but only installs those with xml:lang matches with the language of vocal recognizer motor.
            } catch (Exception ex)
            {
                // Handle exception.
            }
